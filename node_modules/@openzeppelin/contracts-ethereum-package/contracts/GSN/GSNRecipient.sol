 ...
 */
abstract contract GSNRecipient is Initializable, IRelayRecipient, Context {
     ...
     * - the caller must be the `RelayHub` contract.
     */
    function postRelayedCall(bytes calldata context, bool success, uint256 actualCharge, bytes32 preRetVal) override external {
        require(msg.sender == getHubAddr(), "GSNRecipient: caller is not RelayHub");
     ...
     *
     */
    function _postRelayedCall(bytes memory context, bool success, uint256 actualCharge, bytes32 preRetVal) virtual internal ;
